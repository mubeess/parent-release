...
export class TraitRestControllerService {
     ...
     * @throws ApiError
     */
    public static getTraitConfigurationsUsingGet(): CancelablePromise<Array<TraitConfigurationResponse>> {
     ...
     * @throws ApiError
     */
    public static getTraitRatingsUsingGet(): CancelablePromise<Array<TraitRatingResponse>> {
        return __request(OpenAPI, {
            method: 'GET',
