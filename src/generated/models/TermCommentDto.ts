...
export type TermCommentDto = {
    ...
    staff_comment_type?: 'FORM_TEACHER_COMMENT' | 'FORM_TEACHER_CUMULATIVE_COMMENT' | 'HOUSE_MASTER_COMMENT' | 'PRINCIPAL_COMMENT' | 'PRINCIPAL_CUMULATIVE_COMMENT' | 'SUBJECT_TEACHER_COMMENT' | 'VICE_PRINCIPAL_COMMENT' | 'VICE_PRINCIPAL_CUMULATIVE_COMMENT';
